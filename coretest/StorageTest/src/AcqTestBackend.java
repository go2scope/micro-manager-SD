...
/**
 * Test saving directly on the back-end without pulling images into the Java space.
 */
public class AcqTestBackend {
    public static void main(String[] args) {
        ...
        try {
           ...
           // create the new dataset
            ...
            int handle = core.createDataset(savelocation, "test-back" + storageengine, shape, type, "", 0);
            ...
            for(int i = 0; i < numberOfPositions; i++) {
                for(int j = 0; j < numberOfTimepoints; j++) {
                    ...
                    for(int k = 0; k < numberOfChannels; k++) {
                        ...
                        mmcorej.org.json.JSONObject meta = new mmcorej.org.json.JSONObject();
                        ...
                        System.out.printf("Image %d saved in %.1f ms (%.1f MB/s)\n", imgind, tSave, bwsav);
                        imgind++;
                    }
                    if (core.isBufferOverflowed())
                        break;
